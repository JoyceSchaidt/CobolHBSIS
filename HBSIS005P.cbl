      ...
      *----------------------------------------------------------------*
       COPY HBSIS005L.    
      *----------------------------------------------------------------*
       PROCEDURE                       DIVISION USING HBSIS005L.        
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
       1000-INICIALIZA                 SECTION.
           ...
           MOVE ZEROS                  TO COD-RETORNO-HBSIS005L
           MOVE "RELATORIO GERADO COM SUCESSO"
                                       TO MSG-RETORNO-HBSIS005L

           PERFORM 1100-VALIDA-PREENCHIMENTO

           IF COD-CLI-HBSIS005L        NOT EQUAL ZEROS  AND
              RAZ-SOC-HBSIS005L        NOT EQUAL SPACES
      ...
      *----------------------------------------------------------------*
       1100-VALIDA-PREENCHIMENTO       SECTION.
           ...
           IF TIPO-ORD-HBSIS005L       NOT EQUAL "A" AND
              TIPO-ORD-HBSIS005L       NOT EQUAL "D"           
              MOVE 1                   TO COD-RETORNO-HBSIS005L
              MOVE "TIPO DE ORDENACAO COM VALOR NAO PERMITIDO"
                                       TO MSG-RETORNO-HBSIS005L
              PERFORM 3000-FINALIZA
           END-IF

           IF TIPO-CLA-HBSIS005L       NOT EQUAL "C" AND
              TIPO-CLA-HBSIS005L       NOT EQUAL "R"
              MOVE 2                   TO COD-RETORNO-HBSIS005L
              MOVE "TIPO DE CLASSIFICACAO COM VALOR NAO PERMITIDO"
                                       TO MSG-RETORNO-HBSIS005L
              PERFORM 3000-FINALIZA
           END-IF

           IF COD-CLI-HBSIS005L        NOT NUMERIC
              MOVE 3                   TO COD-RETORNO-HBSIS005L
              MOVE "COD CLIENTE COM VALOR NAO PERMITIDO"
                                       TO MSG-RETORNO-HBSIS005L
              PERFORM 3000-FINALIZA
           END-IF

           IF COD-VEND-HBSIS005L       NOT NUMERIC
              MOVE 4                   TO COD-RETORNO-HBSIS005L
      ...
      *----------------------------------------------------------------*
       1200-BUSCAR-CLIENTE             SECTION.
           ...
           MOVE COD-CLI-HBSIS005L      TO COD-CLIENTE-HBSIS002C

           READ ARQ-CLIENTE     RECORD INTO WS-ARQ-CLIENTE
                                   KEY IS COD-CLIENTE-HBSIS002C
           
           IF WS-FL-STATUS-CLI         NOT EQUAL ZEROS
              IF RAZ-SOC-HBSIS005L     NOT EQUAL SPACES
                 MOVE RAZ-SOC-HBSIS005L  
                 ...
                 READ ARQ-CLIENTE 
                   ...
                   IF WS-FL-STATUS-CLI NOT EQUAL ZEROS
                       MOVE 5          TO COD-RETORNO-HBSIS005L
                       MOVE "CLIENTE NAO ENCONTRADO NA BASE"
                                       TO MSG-RETORNO-HBSIS005L
                   END-IF
               ELSE
                   MOVE 6              TO COD-RETORNO-HBSIS005L
                   MOVE "CLIENTE NAO ENCONTRADO NA BASE"
                                       TO MSG-RETORNO-HBSIS005L
               END-IF
           END-IF
      ...
      *----------------------------------------------------------------*
       1300-ABRE-ARQUIVOS              SECTION.
           ...
           IF WS-FL-STATUS-REL         NOT EQUAL ZEROS
              MOVE 9                   TO COD-RETORNO-HBSIS005L
      ...
      *----------------------------------------------------------------*
       2000-PROCESSA                   SECTION.
           ...
           IF  TIPO-ORD-HBSIS005L      EQUAL "A"
               IF  TIPO-CLA-HBSIS005L  EQUAL "C"
                   SORT ARQ-SORT
      ...
      *----------------------------------------------------------------*
       2100-INPUT-SORT                 SECTION.
           ...
           AND WS-FL-STATUS-CLI        NOT EQUAL "10"
              MOVE 10                  TO COD-RETORNO-HBSIS005L
      ...
      *----------------------------------------------------------------*
       2110-ALIMENTA-SORT              SECTION.
           ...
           IF COD-CLI-HBSIS005L        EQUAL ZEROS
              IF RAZ-SOC-HBSIS005L     EQUAL SPACES
                 RELEASE REG-SORT      FROM ARQ-HBSIS002C
              ELSE
                 IF RAZAO-SOCIAL-HBSIS002C       
                                       EQUAL RAZ-SOC-HBSIS005L
                    RELEASE REG-SORT   FROM ARQ-HBSIS002C
                 END-IF
              END-IF
           ELSE
              IF COD-CLIENTE-HBSIS002C EQUAL COD-CLI-HBSIS005L
                 RELEASE REG-SORT      FROM ARQ-HBSIS002C
              END-IF
           END-IF    
           ...
           IF  WS-FL-STATUS-CLI        NOT EQUAL ZEROS
           AND WS-FL-STATUS-CLI        NOT EQUAL "10"
              MOVE 11                  TO COD-RETORNO-HBSIS005L
              MOVE "ERRO NA LEITURA DO ARQUIVO ARQ-CLIENTE" 
                                       TO MSG-RETORNO-HBSIS005L
              PERFORM 3000-FINALIZA
           END-IF
      ...
      *----------------------------------------------------------------*
       2200-OUTPUT-SORT                SECTION.
           ...
           IF WS-FL-STATUS-REL         NOT EQUAL ZEROS
              MOVE 14                  TO COD-RETORNO-HBSIS005L
      ...
      *----------------------------------------------------------------*
       2210-GERA-RELATORIO             SECTION.
           ...
           IF WS-FL-STATUS-REL         NOT EQUAL ZEROS
              MOVE 13                  TO COD-RETORNO-HBSIS005L
      ...
      *----------------------------------------------------------------*
       ...
       9200-EXIT.
           EXIT.
      *----------------------------------------------------------------*
      * FIM DO PROGRAMA HBSIS011S                                      *
      *----------------------------------------------------------------*
       END PROGRAM                     HBSIS011S.
      *----------------------------------------------------------------*