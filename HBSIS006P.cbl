      ...
      *----------------------------------------------------------------*
       COPY HBSIS006L.    
      *----------------------------------------------------------------*
       PROCEDURE                       DIVISION USING HBSIS006L.        
      *----------------------------------------------------------------*
      ...
      *----------------------------------------------------------------*
       1000-INICIALIZA                 SECTION.
           ...
           MOVE ZEROS                  TO COD-RETORNO-HBSIS006L
           MOVE "RELATORIO GERADO COM SUCESSO"
                                       TO MSG-RETORNO-HBSIS006L

           PERFORM 1100-VALIDA-PREENCHIMENTO

           IF COD-VEND-HBSIS006L       NOT EQUAL ZEROS  AND
              NOME-VEND-HBSIS006L      NOT EQUAL SPACES
      ...
      *----------------------------------------------------------------*
       1100-VALIDA-PREENCHIMENTO       SECTION.
           ...
           IF TIPO-ORD-HBSIS006L       NOT EQUAL "A" AND
              TIPO-ORD-HBSIS006L       NOT EQUAL "D"           
              MOVE 1                   TO COD-RETORNO-HBSIS006L
              MOVE "TIPO DE ORDENACAO COM VALOR NAO PERMITIDO"
                                       TO MSG-RETORNO-HBSIS006L
              PERFORM 3000-FINALIZA
           END-IF

           IF TIPO-CLA-HBSIS006L       NOT EQUAL "C" AND
              TIPO-CLA-HBSIS006L       NOT EQUAL "N"
              MOVE 2                   TO COD-RETORNO-HBSIS006L
              MOVE "TIPO DE CLASSIFICACAO COM VALOR NAO PERMITIDO"
                                       TO MSG-RETORNO-HBSIS006L
              PERFORM 3000-FINALIZA
           END-IF

           IF COD-VEND-HBSIS006L       NOT NUMERIC
              MOVE 3                   TO COD-RETORNO-HBSIS006L
      ...
      *----------------------------------------------------------------*
       1200-BUSCAR-VENDEDOR            SECTION.
           ...
           MOVE COD-VEND-HBSIS006L     TO COD-VENDEDOR-HBSIS004C

           READ ARQ-VENDEDOR    RECORD INTO WS-ARQ-VENDEDOR
                                   KEY IS COD-VENDEDOR-HBSIS004C
           
           IF WS-FL-STATUS-VEND        NOT EQUAL ZEROS
              IF NOME-VEND-HBSIS006L   NOT EQUAL SPACES
                 MOVE NOME-VEND-HBSIS006L
                 ...
                 READ ARQ-VENDEDOR 
                   ...
                   IF WS-FL-STATUS-VEND NOT EQUAL ZEROS
                       MOVE 5          TO COD-RETORNO-HBSIS006L
                       MOVE "VENDEDOR NAO ENCONTRADO NA BASE"
                                       TO MSG-RETORNO-HBSIS006L
                   END-IF
               ELSE
                   MOVE 6              TO COD-RETORNO-HBSIS006L
                   MOVE "VENDEDOR NAO ENCONTRADO NA BASE"
                                       TO MSG-RETORNO-HBSIS006L
               END-IF
           END-IF
      ...
      *----------------------------------------------------------------*
       1300-ABRE-ARQUIVOS              SECTION.
           ...
           IF WS-FL-STATUS-REL         NOT EQUAL ZEROS
              MOVE 9                   TO COD-RETORNO-HBSIS006L
      ...
      *----------------------------------------------------------------*
       2000-PROCESSA                   SECTION.
           ...
           IF  TIPO-ORD-HBSIS006L      EQUAL "A"
               IF  TIPO-CLA-HBSIS006L  EQUAL "C"
                   SORT ARQ-SORT
      ...
      *----------------------------------------------------------------*
       2100-INPUT-SORT                 SECTION.
           ...
           AND WS-FL-STATUS-VEND       NOT EQUAL "10"
              MOVE 10                  TO COD-RETORNO-HBSIS006L
      ...
      *----------------------------------------------------------------*
       2110-ALIMENTA-SORT              SECTION.
           ...
           IF COD-VEND-HBSIS006L       EQUAL ZEROS
              IF NOME-VEND-HBSIS006L   EQUAL SPACES
                 RELEASE REG-SORT      FROM ARQ-HBSIS004C
              ELSE
                 IF NOME-VEND-HBSIS004C       
                                       EQUAL NOME-VEND-HBSIS006L
                    RELEASE REG-SORT   FROM ARQ-HBSIS004C
                 END-IF
              END-IF
           ELSE
              IF COD-VENDEDOR-HBSIS004C EQUAL COD-VEND-HBSIS006L
                 RELEASE REG-SORT      FROM ARQ-HBSIS004C
              END-IF
           END-IF    
           ...
           IF  WS-FL-STATUS-VEND       NOT EQUAL ZEROS
           AND WS-FL-STATUS-VEND       NOT EQUAL "10"
              MOVE 11                  TO COD-RETORNO-HBSIS006L
              MOVE "ERRO NA LEITURA DO ARQUIVO ARQ-VENDEDOR" 
                                       TO MSG-RETORNO-HBSIS006L
              PERFORM 3000-FINALIZA
           END-IF
      ...
      *----------------------------------------------------------------*
       2200-OUTPUT-SORT                SECTION.
           ...
           IF WS-FL-STATUS-REL         NOT EQUAL ZEROS
              MOVE 14                  TO COD-RETORNO-HBSIS006L
      ...
      *----------------------------------------------------------------*
       2210-GERA-RELATORIO             SECTION.
           ...
           IF WS-FL-STATUS-REL         NOT EQUAL ZEROS
              MOVE 13                  TO COD-RETORNO-HBSIS006L
      ...
      *----------------------------------------------------------------*
       ...
       9200-EXIT.
           EXIT.
      *----------------------------------------------------------------*
      * FIM DO PROGRAMA HBSIS006P                                      *
      *----------------------------------------------------------------*
       END PROGRAM                     HBSIS006P.
      *----------------------------------------------------------------*